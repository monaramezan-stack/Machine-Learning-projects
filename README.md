...
Random Forest gave the best result, with a test R2 of about 0.975. So this is the model I chose as the best one for this problem.
Tools used
Python
pandas, numpy
...
xgboost
Files
Antenna_Project.ipynb: the notebook with all the code, plots and results
dataset_antenna.csv: the dataset (from Kaggle)
Possible next steps
Try more antenna designs or a wider frequency range
Try other models, like neural networks
Do hyperparameter tuning for Random Forest and XGBoost to get even better results
